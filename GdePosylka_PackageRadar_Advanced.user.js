...
GM_addStyle("\
            ...
            \
            .checkbox_div{position: relative;    left: 400px;    top: -45px; width: 500px;   }\
            ...
            .i_setting_div,.user_codesBox{position: fixed;    border: 1px solid silver;    width: 500px; top: 20%;    left: 50%;    margin-left: -250px; display: none;background: linear-gradient(#ffffff,silver);z-index:9999999;box-shadow: 5px 5px 5px rgba(192, 192, 192, 0.26);}\
...
var $pop_meuni = $("<div id='i_pop_menu_track' style='display:none;position: fixed;width: 330px;left: 50%;top: 50%;border: 1px solid silver;background: linear-gradient(#c1c1c1,white);z-index: 9999999;margin-left: -150px;margin-top: -100px;border-radius: 8px;'>\
